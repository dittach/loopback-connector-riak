...
exports.initialize = function initializeDataSource(dataSource, callback){
  ...
  if (callback) datasource.connctor.connect(callback);
};
...
Riak.prototype.connect = function(apiCallback){
  ...
  this.db = riak.getClient({host: self.settings.host, port: self.settings.port});
...
Raik.prototype._getModelCollectionSpecByName = function(modelName){
